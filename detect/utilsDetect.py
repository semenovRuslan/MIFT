# -*- coding: utf-8 -*-
"""
Created on Sun Dec 24 10:54:07 2017
...
min_wdw_sz =[64, 128] #height, width
step_size = [8, 8]
orientations = 9
pixels_per_cell = (8, 8)
cells_per_block = (4, 4)
...
def hogArray(im, orientations, pixels_per_cell, cells_per_block, visualize, normalize):
